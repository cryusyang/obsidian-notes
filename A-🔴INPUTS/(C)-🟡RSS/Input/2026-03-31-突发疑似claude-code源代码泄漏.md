---
title: "突发！疑似Claude Code源代码泄漏"
url: "https://mp.weixin.qq.com/s/u3hUENRLnenSY8eTQgjxSA"
source: "迪哥讲事"
date: 2026-03-31
fetched: 2026-05-05
language: zh
...
> [!example] AI 摘要
> 文章报道了疑似Claude Code源代码泄露的突发消息，但尚未确认是否为Claude核心模型代码；指出这可能并非首次发生类似泄漏事件；并引发对国产CLI工具借此加速发展的猜测与讨论。

---

<div class="image_content" id="js_image_content">
 <h1 class="rich_media_title">
  突发！疑似Claude Code源代码泄漏
 </h1>
 <p>
  目前还不知道是不是Cc的“大脑本体”，这貌似不是第一次泄漏事件了，国产Cli要崛起了？
 </p>
 <!-- -->
 <!-- -->
 <!-- -->
