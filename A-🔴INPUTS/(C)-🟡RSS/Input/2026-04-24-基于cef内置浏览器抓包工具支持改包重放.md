---
title: "基于cef内置浏览器抓包工具支持改包重放"
url: "https://mp.weixin.qq.com/s/cZVjk3io1FhleR0mkeoJKw"
source: "安全狗的自我修养"
date: 2026-04-24
fetched: 2026-05-05
language: zh
...
> [!example] AI 摘要
> 本文介绍如何利用CEF（Chromium Embedded Framework）内置浏览器实现抓包、改包与重放功能。工具支持手动劫持HTTP请求/响应，并可对流量进行放行、丢弃及编辑操作。作者强调无需基于Chromium从头定制浏览器，直接使用CEF即可快速实现，因其已提供完善的原生UI接口和V8绑定等能力。
...
<div class="image_content" id="js_image_content">
 ...
 <p>
  基于cef内置浏览器抓包工具支持手动劫持放行丢弃支持编辑请求与响应，网上全是用Chromium做的定制浏览器，都带偏了直接用cef就行很简单人家什么都给你做了，原生ui接口V8接口各种的。
